...
class CompaniesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $input = $request->only('company_name_eng','company_name_arab','company_name_reg_eng','company_name_reg_arab','incorporation_date','incorporation_date_hijri','type_of_business_eng','type_of_business_arab','no_br');
    ...
    public function update(Request $request, $id)
    {
        ...
        $Company->update($request->only('company_name_eng','company_name_arab','company_name_reg_eng','company_name_reg_arab','incorporation_date','incorporation_date_hijri','type_of_business_eng','type_of_business_arab','no_br'));
